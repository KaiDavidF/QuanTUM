...
export default function Landing() {
  return (
    <div className="paragraph">
      ...
      <h3>3. Your age does not matter.</h3>
      <p>
        You could be in your first year of your studies or in a PhD programme.
        We are interested in your personality. Still, having expertise in
        certain fields might help significantlz.
      </p>
    </div>
  );
}
